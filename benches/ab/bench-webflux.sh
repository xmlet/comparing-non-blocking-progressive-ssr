...
java -Xms512M -Xmx16g -DbenchTimeout=5 -jar pssr-benchmark-spring-webflux/build/libs/pssr-benchmark-spring-webflux-1.0-SNAPSHOT.jar | tee benches/ab/spring-webflux.log &
